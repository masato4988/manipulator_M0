...
#define SW_LIMIT_1_Pin GPIO_PIN_0
#define SW_LIMIT_1_GPIO_Port GPIOC
#define SW_LIMIT_2_Pin GPIO_PIN_1
#define SW_LIMIT_2_GPIO_Port GPIOC
...
#define SW_LIMIT_3_Pin GPIO_PIN_0
#define SW_LIMIT_3_GPIO_Port GPIOB
